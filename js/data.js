...
const portfolioData = {
    ...
    skills: {
        hardSkills: [
            { name: "PHP & Laravel", level: 90, icon: "fab fa-laravel", category: "Backend" },
            { name: "Flutter (Dart)", level: 85, icon: "fas fa-mobile-screen-button", category: "Mobile" },
            { name: "React.js", level: 82, icon: "fab fa-react", category: "Frontend" },
            { name: "MySQL & Database", level: 88, icon: "fas fa-database", category: "Database" },
            { name: "Java", level: 80, icon: "fab fa-java", category: "Backend" },
            { name: "HTML5 & Modern CSS", level: 92, icon: "fab fa-html5", category: "Frontend" },
            { name: "Figma / UI-UX", level: 85, icon: "fab fa-figma", category: "Design" },
            { name: "RESTful API Integration", level: 88, icon: "fas fa-network-wired", category: "Backend" }
        ],
        softwareTools: [
            { name: "Git & GitHub", icon: "fab fa-github", desc: "Version Control" },
            { name: "Figma", icon: "fab fa-figma", desc: "UI/UX & Prototyping" },
            { name: "Microsoft Excel", icon: "fas fa-file-excel", desc: "Data Analysis" },
            { name: "Canva", icon: "fas fa-palette", desc: "Visual Design" },
            { name: "VS Code & Android Studio", icon: "fas fa-laptop-code", desc: "Development IDE" },
            { name: "Postman", icon: "fas fa-paper-plane", desc: "API Testing" }
        ],
        softSkills: [
            { name: "Effective Communication", desc: "Komunikasi dua arah yang lugas, terbukti dalam peran External Relations & Master of Ceremonies." },
            { name: "Teamwork & Collaboration", desc: "Kemampuan adaptasi tinggi dan sinergi aktif dalam tim lintas fungsi teknis maupun operasional." },
            { name: "Critical Thinking & Analysis", desc: "Keahlian membedah requirement kompleks dan memetakan arsitektur solusi sistem yang tepat." },
            { name: "Time Management", desc: "Disiplin mengelola prioritas dan menyelesaikan milestone pekerjaan secara tepat waktu." }
        ]
    },
    ...
    experiences: [
        {
            ...
            techStack: ["PHP", "Laravel", "MySQL", "JavaScript", "Responsive UI", "System Analysis"]
        }
    ],
    ...
    education: [
        {
            ...
            gpa: "3.49 / 4.00",
            thesisTitle: "Pengembangan Dashboard Business Intelligence untuk Analisis Data Akademik Mahasiswa",
            thesisDesc: "Mengembangkan sistem visualisasi dan analitik Business Intelligence untuk mengevaluasi data histori performa akademik mahasiswa serta mendukung pengambilan keputusan strategis di perguruan tinggi."
        }
    ],
    ...
    projects: [
        {
            ...
            shortDesc: "Aplikasi absensi mobile mahasiswa berbasis Flutter dengan fitur verifikasi wajah dan GPS real-time.",
            description: "AttendIT adalah solusi presensi digital yang dirancang untuk mencegah kecurangan absensi. Menggunakan verifikasi biometrik wajah serta deteksi geolokasi GPS real-time untuk memastikan mahasiswa hadir di area kampus pada jam perkuliahan.",
            badge: "Mobile App (Flutter)",
            icon: "fas fa-user-check",
            image: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?auto=format&fit=crop&w=800&q=80",
            techStack: ["Flutter", "Dart", "Face Verification", "Real-time GPS", "REST API", "Mobile UI"],
            features: [
            ...
            githubUrl: "https://github.com/KinataDewa",
            demoUrl: null
        },
        {
            id: "complex-hub",
            ...
            shortDesc: "Sistem manajemen warga online lengkap dengan fitur Autentikasi, Dashboard, UI responsif, dan backend keuangan.",
            description: "ComplexHub adalah platform web terpadu untuk digitalisasi tata kelola lingkungan perumahan. Menghadirkan transparansi iuran kas warga, dashboard interaktif, serta modul pencatatan keuangan dan administrasi warga.",
            badge: "Fullstack Web",
            icon: "fas fa-users-gear",
            image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80",
            techStack: ["Laravel", "PHP", "MySQL", "JavaScript", "Bootstrap / Tailwind", "Financial Module"],
            features: [
        ...
        },
        {
            ...
            shortDesc: "Website berbasis PHP berisi peraturan JTI yang dapat diakses oleh dosen, admin, DPA, dan mahasiswa sesuai hak akses.",
            description: "Platform terpusat untuk publikasi dan penegakan regulasi tata tertib akademik Jurusan Teknologi Informasi Polinema. Memudahkan mahasiswa, dosen pengampu, DPA, dan admin dalam memantau peraturan dan catatan kedisiplinan.",
            badge: "Web System (PHP)",
            icon: "fas fa-scale-balanced",
            image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=800&q=80",
            techStack: ["PHP", "MySQL", "Role-Based Access Control (RBAC)", "HTML5/CSS3", "JavaScript"],
            features: [
        ...
        },
        {
            ...
            period: "2025 – 2026",
            shortDesc: "Pengembangan Dashboard Business Intelligence untuk analisis menyeluruh data akademik mahasiswa.",
            description: "Sistem Business Intelligence komprehensif yang mengubah data akademik mentah menjadi wawasan visual interaktif. Memfasilitasi pemangku kepentingan dalam mendeteksi tren kelulusan, evaluasi kurikulum, dan performa akademik mahasiswa.",
            badge: "Business Intelligence & Data",
            icon: "fas fa-chart-pie",
            image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80",
            techStack: ["Business Intelligence", "Data Analytics", "MySQL", "PHP / Python", "Data Visualization"],
            features: [
        ...
        },
        {
            ...
            shortDesc: "Sistem informasi maintenance gedung mencakup 5 kategori proses operasional (form harian, pengecekan, perawatan, perbaikan, aduan).",
            description: "Sistem digitalisasi pemeliharaan infrastruktur gedung Plaza SUA yang dirancang dari tahap requirement gathering, arsitektur database, antarmuka pengguna, hingga user acceptance testing bersama staf operasional di lapangan.",
            badge: "Industrial Enterprise Web",
            icon: "fas fa-building-shield",
            image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=800&q=80",
            techStack: ["PHP", "Laravel", "MySQL", "Operational Workflow", "Responsive UI"],
            features: [
        ...
        },
        {
            ...
            shortDesc: "Modernisasi sistem buku tamu dengan penangkapan foto otomatis, timestamp, dan pencatatan Tamu Event.",
            description: "Transformasi sistem registrasi tamu kantor menjadi lebih modern, aman, dan responsif. Dilengkapi dengan auto-photo capture berbasis timestamp kamera serta manajemen tamu acara khusus.",
